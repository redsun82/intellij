...
public class BuildSystemProviderWrapper implements BuildSystemProvider {
  ...
  public BuildSystemProviderWrapper(Supplier<Project> projectSupplier) {
    this.innerProvider =
        () -> {
          ...
          BuildSystemName type = Blaze.getBuildSystemName(project);
  ...
  /**
   * Sets a supplier for {@link BuildResultHelper} instcances to be return by {@code
   ...
   *
   * <p>If not set, or set to {@code null}, the {@link BuildBinaryType} returned will come form the
   * wrapped instance.
   */
